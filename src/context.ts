...
/**
 * CrosswordContextType represents the type of the crossword puzzle itself, as well as provides
 * callbacks for the core implementation of crossword user-interaction logic. This ensures that any
 * number of individual components can leverage a single core implementation.
 */
export interface CrosswordContextType {
  rows: number; // The number of rows in the crossword.
  cols: number; // The number of columns in the crossword.
  gridData: GridData; // The crossword grid data, including player guesses and "correct" status.
  clues?: CluesData; // The across/down clues, including "correct" status.
...
/**
 * CrosswordContext represents the crossword puzzle itself, as well as provides callbacks for the
 * core implementation of crossword user-interaction logic. This ensures that any number of
 * individual components can leverage a single core implementation.
 */
